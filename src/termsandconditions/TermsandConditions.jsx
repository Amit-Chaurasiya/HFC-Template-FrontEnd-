    ...
    <>
      ...
      <div className="pages_container">
        <div className="privacypolicy_container">
          <h2 className="contact_header">Terms and Conditions</h2>
          <hr />
          <div className="privacy_policy">
            <p>Welcome to Help For Coders!</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of Help For Coders's Website, located at
              https://www.helpforcoders.com.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Help For Coders if you do not
            ...
            <p>
              We employ the use of cookies. By accessing Help For Coders, you
              agreed to use cookies in agreement with the Help For Coders's
              Privacy Policy.{" "}
            </p>
            ...
            <p>
              Unless otherwise stated, Help For Coders and/or its licensors own
              the intellectual property rights for all material on Help For
              Coders. All intellectual property rights are reserved. You may
              access this from Help For Coders for your own personal use
            ...
            <p>You must not:</p>
            <ul>
              <li>1. Republish material from Help For Coders</li>
              <li>
                2. Sell, rent or sub-license material from Help For Coders
              </li>
              <li>
                3. Reproduce, duplicate or copy material from Help For Coders
              </li>
              <li>4. Redistribute content from Help For Coders</li>
            </ul>
            <br />
            <p>
            ...
            <p>
              ...
              Help For Coders does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of Help For Coders, its agents and/or
              ...
              applicable laws, Help For Coders shall not be liable for the
            ...
            <br />
            <p>
              Help For Coders reserves the right to monitor all Comments and to
            ...
            <br />
            <p>
              You hereby grant Help For Coders a non-exclusive license to use,
            ...
            <p>
              ...
              Help For Coders; and (d) the link is in the context of general
            ...
            <p>
              ...
              by sending an e-mail to Help For Coders. Please include your name,
            ...
            <p>
              No use of Help For Coders's logo or other artwork will be allowed
            ...
            <p>
              ...
              <br /> (a) are subject to the preceding paragraph; and <br />
